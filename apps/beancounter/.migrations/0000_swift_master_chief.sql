...
--> statement-breakpoint
CREATE TABLE "beancounter_structure_snapshots" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"structure_id" text NOT NULL,
	"recorded_at" timestamp with time zone NOT NULL,
	"fuel_expires_at" timestamp with time zone,
	"services_json" jsonb DEFAULT 'null'::jsonb,
...
--> statement-breakpoint
ALTER TABLE "beancounter_structure_monitor_instances" ADD CONSTRAINT "beancounter_structure_monitor_instances_structure_id_beancounter_structure_monitor_structures_structure_id_fk" FOREIGN KEY ("structure_id") REFERENCES "public"."beancounter_structure_monitor_structures"("structure_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "beancounter_structure_monitor_runs" ADD CONSTRAINT "beancounter_structure_monitor_runs_structure_id_beancounter_structure_monitor_structures_structure_id_fk" FOREIGN KEY ("structure_id") REFERENCES "public"."beancounter_structure_monitor_structures"("structure_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "beancounter_structure_snapshots" ADD CONSTRAINT "beancounter_structure_snapshots_structure_id_beancounter_structure_monitor_structures_structure_id_fk" FOREIGN KEY ("structure_id") REFERENCES "public"."beancounter_structure_monitor_structures"("structure_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "beancounter_structure_monitor_structures" ADD CONSTRAINT "beancounter_structure_monitor_structures_corporation_id_beancounter_structure_monitor_corporations_corporation_id_fk" FOREIGN KEY ("corporation_id") REFERENCES "public"."beancounter_structure_monitor_corporations"("corporation_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "beancounter_structure_snapshots_structure_id_idx" ON "beancounter_structure_snapshots" USING btree ("structure_id");--> statement-breakpoint
CREATE INDEX "beancounter_structure_snapshots_recorded_at_idx" ON "beancounter_structure_snapshots" USING btree ("structure_id","recorded_at");--> statement-breakpoint
