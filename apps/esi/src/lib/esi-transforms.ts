...
export function transformMembers(data: EsiCorporationMembers[]): CorporationMembers {
	return data.map((member) => String(member))
}

export function transformMemberTracking(
...
export function transformAssets(assets: any[]): CorporationAsset[] {
...
export function transformStructures(structures: any[]): CorporationStructure[] {
...
export function transformOrders(orders: any[]): CorporationOrder[] {
...
export function transformContracts(contracts: any[]): CorporationContract[] {
...
export function transformIndustryJobs(jobs: any[]): CorporationIndustryJob[] {
	return jobs.map((job) => ({
...
export function transformKillmails(killmails: any[]): CorporationKillmail[] {
