...
import { createDb } from '@repo/orchestrator'
...
async function main() {
	...
	console.log('Running migrations for orchestrator worker...')

	const db = createDb(databaseUrl)
	await migrate(db as any, { migrationsFolder: drizzleConfig.out! })
